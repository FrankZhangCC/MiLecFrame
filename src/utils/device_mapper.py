...
class DeviceMapper:
            ...
            if not file_path.exists():
                ...
                with open(file_path, 'w', newline='', encoding='utf-8') as csvfile:
                    ...
                    if 'camera' in str(file_path):
                        ...
                        writer.writerow(['original_lens', 'mapped_lens'])  # 写入表头
    ...
    def add_lens_mapping(self, original_lens: str, mapped_lens: str) -> bool:
        """
        添加新的镜头映射
        ...
        try:
            ...
            with open(self.lens_db_path, 'a', newline='', encoding='utf-8') as csvfile:
                writer = csv.writer(csvfile)
                writer.writerow([original_lens, mapped_lens])
            
            print(f"成功添加镜头映射: {original_lens} -> {mapped_lens}")
            return True
